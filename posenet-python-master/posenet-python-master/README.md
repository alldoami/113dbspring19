### Weight Lift Helper
Please run the Weight Lift Helper jupyter notebook to run the code.

The following instructions below are the prerequisite software needed to run the notebook.
